 ...
 */
class theme_edumy_core_h5p_renderer extends renderer {
    ...
    public function h5p_alter_styles(&$styles, $libraries, $embedType) {
        global $CFG;
            ...
            $styles[] = (object) array(
                'path'    => $CFG->httpswwwroot . '/theme/edumy/h5p/style/custom.css',
                'version' => '?ver=0.0.1',
            );
    }
    ...
    public function h5p_alter_scripts(&$scripts, $libraries, $embedType) {
        ...
        if (
            ...
            $scripts[] = (object) array(
                'path'    => $CFG->httpswwwroot . '/theme/edumy/h5p/js/' . $include_file,
                'version' => '?ver=0.0.1',
            );
        }
    }
 ...
 * functions declared there.
 */
class theme_edumy_mod_hvp_renderer extends mod_hvp_renderer {
